...
from src.http.composer import (compose_delete_product,
...
from src.http.composer.dev.register_product_composer import \
    compose_dev_register_product
from src.http.composer.dev.select_products_grouped_by_days import \
    compose_dev_select_products_by_day
from src.http.composer.dev.select_products_in_especific_day import \
    compose_dev_select_products_in_especific_day
from src.http.composer.dev.update_product_status import \
    compose_dev_update_product_status
